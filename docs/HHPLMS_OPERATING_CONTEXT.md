...
**Saved Draft Viewer:** user screenshot δείχνει private page asset 401 και `Unable to prepare required Viewer image: viewer-runtime-1`. Η προηγούμενη συζήτηση εντόπισε πιθανό startup/preload transient-authorization defect. Καταγράφεται ως pending issue, όχι ως νέα end-to-end αναπαραγωγή εδώ.
