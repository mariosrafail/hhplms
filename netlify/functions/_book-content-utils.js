...
export function readQuery(event) {
  ...
  return {
    ...
    assetSha256: params.assetSha256 || "",
    assetRole: params.assetRole || "",
    teacherActivityId: params.teacherActivityId || "",
    teacherAssetActivityId: params.teacherAssetActivityId || "",
    ui: params.ui || "",
    uiBindingId: params.uiBindingId || "",
    uiFont: params.uiFont || "",
    uiOwnerSha256: params.uiOwnerSha256 || "",
