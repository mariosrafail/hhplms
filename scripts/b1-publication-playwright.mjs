...
const result = spawnSync(process.execPath, ['--test', '--test-concurrency=1', 'tests/integration/b1-managed-publication.test.js', 'tests/integration/b1-content-editions.test.js'], { stdio: 'inherit', env: { ...process.env, B1_PUBLICATION_BROWSER: '1', B1_EDITION_BROWSER: '1' } });
