import { assertStudentsBookOverview } from "./multi-book-students-overview-assertions.mjs";
...
try {
  ...
  const { studentsPagesReview, studentsFrameSource, residentIframeLocator, residentIframe, studentsOverviewMetrics, residentExchangeStart, residentCatalogStart, residentPreviewLoadStart } = await assertStudentsBookOverview({
