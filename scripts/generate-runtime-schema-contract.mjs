...
export function runtimeSchemaContractData(migrations) {
  ...
  return {
    ...
    expectedMigrations: migrations.map(({ filename, compatibleChecksums }) => ({
      ...
      ...(["062_b1_managed_publication.sql", "063_b1_immutable_package_ui.sql", "064_teacher_overview_ui.sql", "065_teacher_overview_managed_font.sql", "066_content_editions.sql", "067_wordlist_sources.sql", "068_vocabulary_ui_bindings.sql", "069_b1_content_editions.sql"].includes(filename) ? { featureOptional: true } : {}),
    })),
