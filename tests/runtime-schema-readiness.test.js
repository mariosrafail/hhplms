...
test("runtime readiness requires expected history but allows forward-compatible extras", async () => {
  ...
  assert.deepEqual(optional, ["062_b1_managed_publication.sql", "063_b1_immutable_package_ui.sql", "064_teacher_overview_ui.sql", "065_teacher_overview_managed_font.sql", "066_content_editions.sql"]);
